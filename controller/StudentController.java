...
public class StudentController {
    ...
    public String Dashboard(Model model, @PathVariable String srn) {
        List<Student> teammember = studentService.getTeamMembersByStudentUSN(srn);
    ...
    public String TeamRegSubmit(@PathVariable String srn, @ModelAttribute("project") Project project, @ModelAttribute("teacher") UserAccount teacher) {
