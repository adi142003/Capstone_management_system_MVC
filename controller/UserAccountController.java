...
public class UserAccountController {
    ...
    @Autowired
    public UserAccountController(ProjectRepository projectRepository, UserAccountService userAccountService, StudentService studentService, TeacherService teacherService, @Qualifier("handlerExceptionResolver") HandlerExceptionResolver handlerExceptionResolver, UserAccountRepository userAccountRepository) {
...
//    }
    ...
    public String loginSubmit(@ModelAttribute("userAccount") UserAccount userAccount) {
        UserAccount savedUserAccount = userAccountRepository.findByUsn(userAccount.getUsn());
        String pass;
            try{
            ...
            String t = "Teaching Faculty";
            String s ="Student";
            if(Objects.equals(pass,userAccount.getPassword())) {
                if(Objects.equals(t,savedUserAccount.getRole())){
                    return "redirect:/teacher/projects/"+savedUserAccount.getUsn();
                }
                if(Objects.equals(s,savedUserAccount.getRole())){

                    return "redirect:/project/dashboard/"+savedUserAccount.getUsn();
                }
                else
